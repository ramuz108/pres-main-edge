...
class Minisecond extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  return (
    <div className="App">
        ...
        <table cellpadding="15">
         ...
         <br /><br /><br /><br />   
        <Button circular color="red" size="huge" onClick={()=> document.location.href="http://localhost:3000/dash1"} icon="arrow left" />
        </td>
            <td>
            <ReactSpeedometer
        width={450}
...
export default withSnackbar(Minisecond);
